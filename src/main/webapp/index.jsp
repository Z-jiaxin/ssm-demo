	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@daxin.com">
			      <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">email</label>
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@daxin.com">
			      <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
	...
	<script type="text/javascript">
		...
		function validate_add_form(){
			...
			if(!regName.test(empName)){
				...
				$("#empName_add_input").next("span").text("用户名可以是2-5位中文或者6-12位英文和数字的组合"); */
				show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者6-12位英文和数字的组合");
				return false;
			}else{
		...
		//先对要提交给服务器的数据进行校验
		/* $("#empName_add_input,#email_add_input").blur(function(){
